...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        ...
        try {
            ...
            $sql = "SELECT * FROM producer WHERE username = ?";
            ...
            if (!$user) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    $_SESSION['user_type'] = 'producer'; //Determines access rights
...
<div class="form-container">
    <div class="form">
        ...
        <form action="prod-login.php" method="POST" autocomplete="off">
        ...
        <p class="switch-login-signup">
            Trying to login as a customer? <a href="login.php">Login Here</a>
        </p>
